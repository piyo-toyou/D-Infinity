...
class FlowDirection(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'flowdirection20'

    def displayName(self):
        return self.tr('Flow Direction 20')
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for i, j in np.ndindex(my_array.shape):
            returnarrayF[i][j] = Flag(my_array, i, j)
        ...
        while True:
            if np.argwhere(returnarrayF == 1).size:
                ...
                break
            Flat(my_array, returnarrayF, returnarrayD, i, j)
        ...
        while True:
            if np.argwhere(returnarrayF == 2).size:
                ...
                break
            Sink(my_array, returnarrayF, returnarrayD, i, j)
